...
namespace Mozgoslav.Infrastructure.Persistence.EfMigrations
{
    ...
    [Migration("20260502034017_AddDownloadJobs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mozgoslav.Domain.Entities.DownloadJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.HasIndex("CatalogueId")
                        .HasDatabaseName("ix_download_jobs_catalogue_id");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_download_jobs_created_at");

                    b.HasIndex("State")
                        .HasDatabaseName("ix_download_jobs_state");
            ...
            modelBuilder.Entity("Mozgoslav.Domain.Entities.Profile", b =>
                {
                    ...
                    b.Property<string>("GlossaryByLanguage")
                        .IsRequired()
                        .HasColumnType("TEXT")
                        .HasColumnName("glossary_by_language_json");
                    ...
                    b.Property<string>("LlmModelOverride")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("")
                        .HasColumnName("llm_model_override");

                    b.Property<string>("LlmProviderOverride")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("")
                        .HasColumnName("llm_provider_override");
