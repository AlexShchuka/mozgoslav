...
// BC-050 — Devices sub-view lists every paired Syncthing device. "Pair new
// device" reuses the existing SyncPairing view (QR + accept pending) inside
// a modal so the tab does not lose context.
