...
function mapSettingsToInput(s: AppSettings): MutationUpdateSettingsMutationVariables["input"] {
  return {
    ...
    syncthingApiKey: s.syncthingApiKey,
    syncthingBaseUrl: s.syncthingBaseUrl,
    obsidianFeatureEnabled: s.obsidianFeatureEnabled,
    mcpServerEnabled: s.mcpServerEnabled,
    mcpServerPort: s.mcpServerPort,
    mcpServerToken: s.mcpServerToken,
    actionsSkillEnabled: s.actionsSkillEnabled,
    remindersSkillEnabled: s.remindersSkillEnabled,
    dictationClassifyIntentEnabled: s.dictationClassifyIntentEnabled,
...
function mapSavedToSettings(
  ...
  return {
    ...
    obsidianFeatureEnabled: dto.obsidianFeatureEnabled ?? false,
    llmProvider: dto.llmProvider,
    llmEndpoint: dto.llmEndpoint,
    llmModel: dto.llmModel,
    llmApiKey: dto.llmApiKey,
    webCacheTtlHours: dto.webCacheTtlHours ?? 24,
    ...
    dictationLanguage: dto.dictationLanguage as AppSettings["dictationLanguage"],
    ...
    dictationClassifyIntentEnabled: dto.dictationClassifyIntentEnabled ?? false,
    syncthingEnabled: dto.syncthingEnabled,
    syncthingObsidianVaultPath: dto.syncthingObsidianVaultPath,
    syncthingApiKey: dto.syncthingApiKey ?? "",
    syncthingBaseUrl: dto.syncthingBaseUrl ?? "",
    mcpServerEnabled: dto.mcpServerEnabled ?? false,
    mcpServerPort: dto.mcpServerPort ?? 51051,
    mcpServerToken: dto.mcpServerToken ?? "",
    actionsSkillEnabled: dto.actionsSkillEnabled ?? false,
    remindersSkillEnabled: dto.remindersSkillEnabled ?? false,
    claudeCliPath: dto.claudeCliPath ?? "",
