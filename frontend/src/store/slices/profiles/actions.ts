...
export const createProfile = (draft: Omit<Profile, "id" | "isBuiltIn">): CreateProfileAction => ({
  type: CREATE_PROFILE,
  payload: draft,
});
...
export const duplicateProfileSuccess = (profile: Profile): DuplicateProfileSuccessAction => ({
