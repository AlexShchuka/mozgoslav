...
// Minimal type shims for uiohook-napi. The package has its own TS types but we
// load it via dynamic import to keep the module importable in environments that
// do not ship the native prebuild (e.g. Jest running on non-macOS CI runners).
