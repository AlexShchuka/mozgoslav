...
> **Status:** Superseded by [`product-vision-2026-04.md`](./product-vision-2026-04.md) (2026-04-25).
> Сохраняется как историческая справка — оригинальная идея «второго мозга для разговоров»,
> с которой стартовал проект. Все противоречия разрешаются в пользу нынешнего вижна.

**Статус:** Draft (superseded)
**Дата:** 2026-04-16
**Авторы:** user + команда
