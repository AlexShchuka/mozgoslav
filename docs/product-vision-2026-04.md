...
- **Owner**: shuka (lead developer, единственный имеющий decision authority по архитектуре).
- **Контрибьюторы**: open per `CONTRIBUTING.md` — любой может форкнуть, прислать PR через стандартный OSS-flow (branch off main, squash-merge, conventional commits).
